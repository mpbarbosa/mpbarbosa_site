...
- ✅ cleanup_old_folders.sh v1.0.0 (documented)
- ✅ consolidate_docs.sh v1.0.0 (documented)
- ✅ enhance_prompt.sh v1.0.0 (documented)
- ✅ copilot_with_enhanced_prompt.sh v1.0.0 (documented)
- ✅ validate_external_links.sh v1.0.0 (documented)
