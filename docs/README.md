...
- **[Workflow Automation Version Evolution](workflow-automation/WORKFLOW_AUTOMATION_VERSION_EVOLUTION.md)** - Complete version history v1.1.3 through v2.0.0 with migration guide
...
- **[Workflow Automation Phase 2 Completion](workflow-automation/WORKFLOW_AUTOMATION_PHASE2_COMPLETION.md)** - Implementation completion report for v1.1.3 (HISTORICAL)
...
- **[AI Prompt Extraction Standard](ai-prompts/AI_PROMPT_EXTRACTION_STANDARD.md)** - Project standard for extracting AI prompts to centralized library (v1.1.3) ⭐ **NEW**
